...
EOF
        ...
        # When quickly taking down one installation of PMEM-CSI and recreating it, we
        # sometimes we get: nodePort: Invalid value: 32000: provided port is already allocated
        #
