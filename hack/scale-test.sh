...
install_pmem_csi () (
    ...
    sed \
        ...
        -e 's;-v=3;-v=3;' \
        -e 's;intel/pmem-csi-driver:canary;gcr.io/k8s-testimages/pohly/pmem-csi-driver:canary-2020-11-30;' \
        -e 's;pohly/csi-provisioner:.*;gcr.io/k8s-testimages/pohly/csi-provisioner:2020-12-09;' \
